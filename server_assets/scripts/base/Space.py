...
class Space(KBEngine.Entity, GameObject):
    ...
    def createSpawnPointDatas(self):
        ...
        for child in root:
            ...
            position = (float(positionNode[0].text),
    ...
    def teleportSpace(self, entityCall, position, direction, context):
		...
		请求进入某个space中
		"""
        entityCall.cell.onTeleportSpaceCB(self.cell, self.spaceUTypeB,
                                          position, direction)
    ...
    def onGetCell(self):
        ...
        KBEngine.globalData["Spaces"].onSpaceGetCell(self.spaceUTypeB, self,
                                                     self.spaceKey)
